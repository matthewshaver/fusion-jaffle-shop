...
This project runs on Snowflake via dbt platform and uses dbt Fusion. It demonstrates a wide range of dbt features including model contracts, the MetricFlow semantic layer, snapshots, source freshness monitoring, exposures, doc blocks, and custom macros.
